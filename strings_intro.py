...
# To use quotes in a string you alternate the use of the single and double quotes
...
first_name = 'eric'
print(first_name)
print(first_name.title()) # capitalizes the first letter of all words in the string
...
# This block of code does the same but takes the name and combines it in a sentence.
first_name = 'ada'
last_name = 'lovelace'
full_name = first_name + ' ' + last_name
...
# Whitespace stripping, these do not affect the variable itself, just a copy of it that is being printed.
name = ' eric '
...
# in the code below, '-' dashes have been added to show more clearly what stripping does.
name = ' eric '
